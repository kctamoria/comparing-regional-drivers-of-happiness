...
Contributions: Found, cleaned, and merged > 800 global records to analyze the impacts of GDP per capita, freedom, and generosity on national happiness. Analyzed global happiness trends using Python (pandas, seaborn, Plotly, Matplotlib), created visualizations (heatmaps, scatterplots, choropleth maps) to communicate cultural distinctions, and conducted regression analysis (statsmodels) to compare regional differences in economic and social predictors, identifying unique cultural drivers of happiness between Asian and Non-Asian countries.
